        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Warnai Hari - Hari Mu Dengan Laptop Kami</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Toko Laptop Terbaik dan Berkualitas</h2>
        ...
        <section id="produk" class="portfolio">
            <div class="container">
                ...
                <div class="section-title" data-aos="fade-up">
                    <h2>Produk Laptop</h2>
                    <p>Cari Sesuai Keperluan Mengedit Dan Mengcoding Mu </p>
                </div>
                                        ...
                                        <form action="/pembelian/storeinput" method="post" class="form-floating">
                                            ...
                                            <div class="form-floating p-1">
                                                <input type="text" name="banyak" required="required"
                                                    class="form-control">
                                                <label for="floatingInputValue">Banyak Produk yang ingin di
                                                    beli</label>
                                            </div>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 text-lg-left text-center">
                    <div class="copyright">
                        &copy; Copyright <strong>Jevvier</strong>. All Rights Reserved
                    </div>
                    <div class="credits">
