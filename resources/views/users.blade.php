...
@section('konten')
    <div class="container-fluid">
        <div class="text-end m-2"><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahUser"> +
                Tambah user Baru</button></div>
        @if (session('message'))
        ...
        <table class="table table-dark table-hover m-lg-2">
            ...
            @foreach ($users as $p)
                    ...
                    <td>
                        ...
                        @else
                            <button class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#ModalUpdateUser{{ $p->id }}">Update</button> |
                        @endif
                        <button class="btn btn-danger" data-bs-toggle="modal"
                            data-bs-target="#ModalDeleteUser{{ $p->id }}">Delete</button>
                    </td>
                </tr>

                <!-- Ini tampil form update user -->
                <div class="modal fade" id="ModalUpdateUser{{ $p->id }}" tabindex="-1"
                            ...
                            <div class="modal-body">
                                <form action="/user/storeupdate" method="post" class="form-floating">
                                    ...
                                    <div class="form-floating p-1">
                                        ...
                                        <label for="floatingInputValue">Password <b>(*Jika kosong maka menggunakan password
                                                lama*)</b></label>
                                    </div>
                                    <div class="form-floating p-1">
                                        <select name="role" class="form-control">
                                            <option value="petugas"
                                                @if ($p->role == 'petugas') selected="selected" @endif>Petugas
                                            </option>
                                            <option value="admin"
                                                @if ($p->role == 'admin') selected="selected" @endif>Admin</option>
                                        </select>
                ...
                <div class="modal fade" id="ModalDeleteUser{{ $p->id }}" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
